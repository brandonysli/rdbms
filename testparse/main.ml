...
let drop_table_tests =
  [
    ...
    parse_test "DROP TABLE DFDFlkdjfsd;" "DROP TABLE DFDFlkdjfsd;"
      (TDROP "DFDFlkdjfsd");
    parse_test "DROP TABLE DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD;"
      "DROP TABLE DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD;"
      (TDROP "DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD");
  ]
